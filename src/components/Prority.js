...
//         <h2>Task List</h2>
//         <div>
//           <button onClick={() => setSelectedPriority('all')}>All Tasks</button>
//           <button onClick={() => setSelectedPriority('high')}>High Priority</button>
//           <button onClick={() => setSelectedPriority('medium')}>Medium Priority</button>
//           <button onClick={() => setSelectedPriority('low')}>Low Priority</button>
//         </div>
//         <ul>
